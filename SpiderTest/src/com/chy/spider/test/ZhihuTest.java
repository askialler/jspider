...
public class ZhihuTest {
	...
	private static Log log = LogFactory.getLog(ZhihuTest.class);
	...
	public static void main(String[] args) throws ClientProtocolException,
		...
		HttpGet get = new HttpGet(
				"https://kyfw.12306.cn/otn/leftTicket/query?leftTicketDTO.train_date=2014-06-18&leftTicketDTO.from_station=WHN&leftTicketDTO.to_station=IZQ&purpose_codes=ADULT");
